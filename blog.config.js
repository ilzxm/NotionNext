...
const BLOG = {
  ...
  NOTION_PAGE_ID: '3629e6769f9d494990b2c4150e9b4a5a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '派小星', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '派大星的表哥😊', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.hanl.me', // 网站地址
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/nuk_i', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo.hanl.me', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
